            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="email" placeholder="email.anda@nama.domain" value="{{ $valueEmail }}" autofocus />
                </div>
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="password" class="form-control" name="password" placeholder="**********" aria-describedby="password" value="{{ $valuePassword }}" />
                ...
                <div class="mb-5">
                  ...
                  <div class="d-flex justify-content-center">
                      <small class="fw-bold text-danger">{{  Str::of($pesanKesalahan)->toHtmlString() }}</small>
                  </div>
                </div>
              </form>
