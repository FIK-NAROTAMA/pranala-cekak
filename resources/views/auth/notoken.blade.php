          ...
          <div class="card" style="font-family:'Barlow Condensed';">
            <div class="card-body">
              ...
              <div class="mb-2" style="font-size:0.8rem; line-height: 1.2;text-align: justify;text-justify: inter-word;">
                <p>Mohon maaf, <b>tautan</b> yang digunakan ini <b>tidak ditemukan</b> atau telah <b>kadaluwarsa</b>. Silakan menggunakan fasilitas <a href="{{ route('resetform') }}"><b>Lupa Password</b></a> kembali dan memasukkan email address yang digunakan pada sistem Pranala Cekak ini.</p>
